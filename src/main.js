...
function dashboard(){
  ...
  return `${title}<section class="workspace-layout-v2 release16-layout">${left}${atlasChat(brief,tx)}</section><footer class="release-footer"><span>Atlas SmartLedger · Release 16</span><span>Persistent Atlas Executive Copilot</span></footer>`;
}
