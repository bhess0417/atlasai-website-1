  ...
  <div class="workspace">
    <header class="topbar">
      ...
      <div class="top-actions">
        ...
        <span class="release">ATLAS 22.0.1 · NAVIGATION REPAIR</span>
    ...
    <main class="page" id="mainPage">
      <section class="welcome-card">
        <div>
          <span class="micro">ATLAS EXECUTIVE COMMAND CENTER · RELEASE 22.0.1</span>
